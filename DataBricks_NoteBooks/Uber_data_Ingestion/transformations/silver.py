...
def parse_rides_raw():
    ...
    df_parsed=df.withColumn("parsed_rides",from_json(col("rides"), df_rides_schema)).select("parsed_rides.*")
    return df_parsed
