...
This folder defines all source code for the 'Uber_data_Ingestion' pipeline:
...
* Take a look at the sample under "sample_users_uber_data_ingestion.py" to get familiar with the syntax.
